...
(function () {
    ...
    const TRANSLATIONS = {
        en: {
            ...
            // ── Engine status / errors (page context) ──
            statusLoading: "Loading playlist...",
            statusReading: "Reading...",
            statusProcessing: "Processing list...",
            statusSorting: "Sorting...",
            statusCalc: "Calculating new order...",
            statusSaving: "Saving...",
            statusDisco: "Album data...",
            statusAudit: "Auditing...",
            statusSearching: "Searching:",
            statusViews: "YouTube views...",
            statusScrobbles: "My scrobbles...",
            statusDone: "Done!",
            doneAll: "Playlist organized successfully.",
            doneFails: "{n} song(s) had no data and were placed at the end.",
            errTimeout: "Timeout: only {x} of {y} songs loaded. Try again.",
            errF5: "Read error. Refresh the page (F5) and try again.",
            errEmpty: "The playlist is empty.",
            errAuth: "Authentication error. Refresh the page and try again.",
            errBatch: "Persistent failure while saving (batch {n}/{t}). Sorting aborted to protect your playlist. Wait a few minutes and try again.",
            errBadKey: "Your Last.fm API key seems invalid. Check it in the extension settings.",
            errBadUser: "Last.fm user not found. Check the username in the extension settings.",
            errNoUser: "Set your Last.fm username and API key in the extension settings!",
            ...
            txtHallFame: "Artists with the highest average views per song play first (with their full discography).",
            ...
            cacheDesc: "If a song got wrong data, clear the cache and sort again.",
            btnClearCache: "Clear cache",
            cacheCleared: "Cache cleared!",
            cacheClearTab: "Open YouTube Music first.",
        ...
        pt: {
            ...
            // ── Engine status / errors (page context) ──
            statusLoading: "Carregando playlist...",
            statusReading: "Lendo...",
            statusProcessing: "Processando lista...",
            statusSorting: "Ordenando...",
            statusCalc: "Calculando nova ordem...",
            statusSaving: "Salvando...",
            statusDisco: "Dados dos álbuns...",
            statusAudit: "Auditando...",
            statusSearching: "Buscando:",
            statusViews: "Views do YouTube...",
            statusScrobbles: "Meus scrobbles...",
            statusDone: "Pronto!",
            doneAll: "Playlist organizada com sucesso.",
            doneFails: "{n} música(s) sem dados foram colocadas no final.",
            errTimeout: "Tempo esgotado: só carregou {x} de {y} músicas. Tente de novo.",
            errF5: "Erro de leitura. Atualize a página (F5) e tente de novo.",
            errEmpty: "A playlist está vazia.",
            errAuth: "Erro de autenticação. Atualize a página e tente de novo.",
            errBatch: "Falha persistente ao salvar (lote {n}/{t}). Ordenação abortada para proteger sua playlist. Aguarde alguns minutos e tente novamente.",
            errBadKey: "Sua chave de API do Last.fm parece inválida. Confira nas configurações da extensão.",
            errBadUser: "Usuário do Last.fm não encontrado. Confira o nome nas configurações da extensão.",
            errNoUser: "Configure seu usuário e chave do Last.fm nas configurações da extensão!",
            ...
            txtHallFame: "Artistas com a melhor média de views por música tocam primeiro (com a discografia inteira).",
            ...
            cacheTitle: "Cache de Metadados",
            cacheDesc: "Se alguma música pegou dados errados, limpe o cache e organize de novo.",
            btnClearCache: "Limpar cache",
            cacheCleared: "Cache limpo!",
            cacheClearTab: "Abra o YouTube Music primeiro.",
